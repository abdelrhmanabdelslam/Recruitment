...
{
   public  interface IPostJobRoleRepository : ICreateRepository<PostJobRole>, IReadRepository<PostJobRole>, IUpdateRepository<PostJobRole>, IDeleteRepository<PostJobRole>
    {
