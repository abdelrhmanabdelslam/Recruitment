...
{
   public  interface ICompanyTypeRepository : ICreateRepository<CompanyType>, IReadRepository<CompanyType>, IUpdateRepository<CompanyType>, IDeleteRepository<CompanyType>
    {
