...
{
   public  interface ICompanyInformationRepository : ICreateRepository<CompanyInformation>, IReadRepository<CompanyInformation>, IUpdateRepository<CompanyInformation>, IDeleteRepository<CompanyInformation>
    {
