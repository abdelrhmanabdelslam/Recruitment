...
{
   public  interface ICareerLevelRepository : ICreateRepository<CareerLevel>, IReadRepository<CareerLevel>, IUpdateRepository<CareerLevel>, IDeleteRepository<CareerLevel>
    {
