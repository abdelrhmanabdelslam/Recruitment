...
{
   public  interface ICompanyOnlinePresenceRepository : ICreateRepository<CompanyOnlinePresence>, IReadRepository<CompanyOnlinePresence>, IUpdateRepository<CompanyOnlinePresence>, IDeleteRepository<CompanyOnlinePresence>
    {
