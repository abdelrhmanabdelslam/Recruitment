...
{
   public  interface ICurrentCareerLevelRepository : ICreateRepository<CurrentCareerLevel>, IReadRepository<CurrentCareerLevel>, IUpdateRepository<CurrentCareerLevel>, IDeleteRepository<CurrentCareerLevel>
    {
