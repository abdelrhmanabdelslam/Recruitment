...
{
   public  interface ICompanySizeRepository : ICreateRepository<CompanySize>, IReadRepository<CompanySize>, IUpdateRepository<CompanySize>, IDeleteRepository<CompanySize>
    {
