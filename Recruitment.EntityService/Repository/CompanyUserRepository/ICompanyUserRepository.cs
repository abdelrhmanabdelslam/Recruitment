...
{
   public  interface ICompanyUserRepository : ICreateRepository<CompanyUser>, IReadRepository<CompanyUser>, IUpdateRepository<CompanyUser>, IDeleteRepository<CompanyUser>
    {
